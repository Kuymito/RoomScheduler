...
const Topbar = ({ onToggleSidebar, isSidebarCollapsed, isMobileSidebarOpen, isSmallScreen, breadcrumbs, userIconRef, onNotificationIconClick, notificationIconRef, hasUnreadNotifications, onUserIconClick, showToggleButton = true }) => {
            ...
            {breadcrumbs.map((crumb, index) => (
              <React.Fragment key={index}>
                {crumb.href ? (
                  ...
                  <span className="md:max-w-[400px] sm:max-w-[200px] xs:max-w-[100px] max-w-[40px] text-blue-700 dark:text-blue-400 truncate" title={crumb.label}>{crumb.label}</span>
                )}
