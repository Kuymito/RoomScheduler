...
const ProfileContent = () => {
    ...
    useEffect(() => {
        if (profileResponse) {
            const initialData = {
                firstName: profileResponse.firstName || "Admin",
                lastName: profileResponse.lastName || "",
                email: profileResponse.email || "admin@example.edu",
                phoneNumber: profileResponse.phone || "+855 12 345 678",
                address: profileResponse.address || "Phnom Penh, Cambodia",
                    ...
                    <div className="info-card p-3 sm:p-4 bg-white border border-num-gray-light dark:bg-gray-800 dark:border-gray-700 shadow-custom-light rounded-lg">
                     ...
                     <div className="info-card-password p-3 sm:p-4 bg-white border border-num-gray-light dark:bg-gray-800 dark:border-gray-700 shadow-custom-light rounded-lg">
                        ...
                        <div className="space-y-4">
                             <div className="flex gap-3 flex-wrap">
                                {renderPasswordField("Current Password", "currentPassword", profileData.password, () => {}, "current", true)}
