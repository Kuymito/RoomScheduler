...
import RightSectionSkeleton from './components/RightSectionSkeleton';

/**
 * This is now a Server Component. It renders the static parts of the page on the server.
 * The interactive login form is loaded as a Client Component.
 */
export default function LoginPage() {
    return (
        <div className="min-h-screen w-screen flex font-sans">
            {/* Left Column (Info Section) - This part is static and perfect for a Server Component */}
            <div className="hidden md:flex md:w-3/5 bg-[#3165F8] text-white items-center justify-center p-6 sm:p-8 md:p-12 lg:p-16 relative overflow-hidden">
                ...
                <div className="relative z-10 max-w-lg sm:max-w-xl lg:max-w-2xl">
                    <Image
                        src="/images/LOGO-NUM-1.png" // Assumes image is in the `public` folder
                        alt="University Logo"
                        width={112} 
                        height={112}
                        priority={true}
            ...
            <div className="w-full md:w-2/5 bg-[#E0E4F3] flex items-center justify-center p-6 sm:p-8 md:p-12 lg:p-16">
                {/* Suspense shows a fallback skeleton UI while the interactive RightSection component loads. */}
