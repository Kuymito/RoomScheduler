...
const RequestIcon = ({ className }) => (
    <div className={`flex items-center justify-center w-5 h-5 bg-red-500 rounded-full border-2 border-white dark:border-gray-800 ${className}`}>
...
const StatusIcon = ({ status }) => {
    switch (status) {
        case 'PENDING':
            return <RequestIcon className="absolute -bottom-1 -right-1" />;
        case 'APPROVED':
