  ...
  return (
    <div className="admin-popup absolute w-[299px] right-5 top-20 bg-white dark:bg-gray-700 shadow-custom-heavy rounded-[5px] z-[1000]">
      ...
      <div className="admin-popup-options p-2.5 flex flex-col">
        <Link 
          href="/admin/profile" 
          className="popup-option w-full h-10 gap-4 bg-white dark:bg-gray-700 rounded-[5px] flex items-center cursor-pointer px-4 mb-1.5 hover:bg-gray-50 dark:hover:bg-gray-600"
        >
