    ...
    <div className="min-h-screen w-screen flex flex-col lg:flex-row">
      ...
      <div className="lg:w-2.5/4 w-full bg-blue-800 text-white flex items-center justify-center p-6 sm:p-8 md:p-12 lg:p-16 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-sm sm:max-w-md lg:max-w-lg">
          <img src="/images/logo.png" alt="University Logo" className="mx-auto mb-4 w-16 sm:w-20 md:w-24 lg:w-28" />
          <h1 className="text-3xl font-bold mb-2 text-center">សាកលវិទ្យាល័យជាតិគ្រប់គ្រង</h1>
          <h2 className="text-xl font-semibold mb-6 text-center">Nation University of Management</h2>
      ...
      {/* Right Column */}
      <div className="lg:w-1.5/4 w-full bg-white flex items-center justify-center p-6 sm:p-8 md:p-12 lg:p-16">
