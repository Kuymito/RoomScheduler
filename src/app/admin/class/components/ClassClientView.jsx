...
const Spinner = () => ( <svg className="animate-spin sm:h-5 h-2 sm:w-5 w-2 text-gray-500 dark:text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"><circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle><path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path></svg> );
            ...
            <div className="flex items-center justify-between mt-2 sm:mb-4 mb-2 sm:gap-2 gap-1">
                <div className="flex items-center gap-2">
                    ...
                    <div ref={filterMenuRef} className="relative inline-block text-left">
                        <div>
                            <button type="button" onClick={() => setIsFilterMenuOpen(!isFilterMenuOpen)} className="inline-flex justify-center w-full rounded-lg border border-gray-300 shadow-sm sm:px-4 px-2 py-1.5 bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-600 dark:bg-gray-700 dark:border-gray-700 dark:text-gray-200 dark:hover:bg-gray-600 dark:focus:ring-offset-gray-800" id="menu-button" aria-expanded="true" aria-haspopup="true">
                        ...
                        <div className="origin-top-left absolute left-0 mt-2 sm:w-56 w-32 rounded-lg shadow-lg bg-white ring-1 ring-black ring-opacity-5 focus:outline-none dark:bg-gray-800 dark:ring-gray-700 z-10" role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabIndex="-1">
                            <div className="py-1" role="none">
                                ...
                                <div className="sm:px-4 px-2 sm:py-2 py-1 sm:text-sm text-[7px] text-gray-400">Class Type</div>
                                <button onClick={() => setOnlineClassFilter(!onlineClassFilter)} className={`${onlineClassFilter ? 'bg-gray-100 text-gray-900 dark:bg-gray-700 dark:text-white' : 'text-gray-700 dark:text-gray-300'} hover:bg-gray-200 hover:dark:bg-gray-600 block w-full text-left sm:px-4 px-2 sm:py-2 py-1 sm:text-sm text-[7px]`} role="menuitem" tabIndex="-1">Online Class</button>
                                <button onClick={() => setExpiredClassFilter(!expiredClassFilter)} className={`${expiredClassFilter ? 'bg-gray-100 text-gray-900 dark:bg-gray-700 dark:text-white' : 'text-gray-700 dark:text-gray-300'} hover:bg-gray-200 hover:dark:bg-gray-600 block w-full text-left sm:px-4 px-2 sm:py-2 py-1 sm:text-sm text-[7px]`} role="menuitem" tabIndex="-1">Expired Class</button>
                                <button onClick={() => setUnassignedClassFilter(!unassignedClassFilter)} className={`${unassignedClassFilter ? 'bg-gray-100 text-gray-900 dark:bg-gray-700 dark:text-white' : 'text-gray-700 dark:text-gray-300'} hover:bg-gray-200 hover:dark:bg-gray-600 block w-full text-left sm:px-4 px-2 sm:py-2 py-1 sm:text-sm text-[7px]`} role="menuitem" tabIndex="-1">Unassigned Class</button>
                            </div>
                        </div>
                        )}
                    </div>
                </div>
                <button type="button" onClick={() => setShowCreatePopup(true)} className="text-white bg-[#75B846] hover:bg-[#87D94D] focus:ring-2 focus:ring-green-600 font-medium rounded-md sm:text-xs text-[7px] sm:px-3 px-1.5 sm:py-2 py-1.5 text-center inline-flex items-center dark:bg-[#75B846] me-2 dark:hover:bg-[#79c344] dark:focus:ring-green-800 gap-1">
                ...
                <table className="w-full rounded-lg sm:text-xs text-[7px] text-left rtl:text-right text-gray-500">
                    <thead className="sm:text-xs text-[7px] text-gray-700 border-b border-gray-200 bg-gray-50 dark:text-gray-400 dark:border-gray-600 dark:bg-gray-700">
                        <tr>
                            ...
                            <th scope="col" className="sm:px-6 px-2 sm:py-2.5 py-1.5 cursor-pointer lg:table-cell hidden hover:bg-gray-100 dark:hover:bg-gray-600" onClick={() => handleSort('generation')}>
                                <div className="flex items-center">Gen {getSortIndicator('generation')}</div>
                            </th>
                            <th scope="col" className="sm:px-6 px-2 sm:py-2.5 py-1.52 cursor-pointer lg:table-cell hidden hover:bg-gray-100 dark:hover:bg-gray-600" onClick={() => handleSort('group')}>
                                <div className="flex items-center">Group {getSortIndicator('group')}</div>
                            </th>
                            <th scope="col" className="sm:px-6 px-2 sm:py-2.5 py-1.5 cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-600" onClick={() => handleSort('major')}>
                                <div className="flex items-center">Major {getSortIndicator('major')}</div>
                            </th>
                            <th scope="col" className="sm:px-6 px-2 sm:py-2.5 py-1.5 cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-600" onClick={() => handleSort('degrees')}>
                                <div className="flex items-center">Degree {getSortIndicator('degrees')}</div>
                            </th>
                            <th scope="col" className="sm:px-6 px-2 sm:py-2.5 py-1.5 cursor-pointer 2xl:table-cell hidden hover:bg-gray-100 dark:hover:bg-gray-600" onClick={() => handleSort('faculty')}>
                                <div className="flex items-center">Faculty {getSortIndicator('faculty')}</div>
                            </th>
                            <th scope="col" className="sm:px-6 px-2 sm:py-2.5 py-1.5 cursor-pointer 2xl:table-cell hidden hover:bg-gray-100 dark:hover:bg-gray-600" onClick={() => handleSort('semester')}>
                                <div className="flex items-center">Semester {getSortIndicator('semester')}</div>
                            </th>
                            <th scope="col" className="sm:px-6 px-2 sm:py-2.5 py-1.5 cursor-pointer sm:table-cell hidden hover:bg-gray-100 dark:hover:bg-gray-600" onClick={() => handleSort('shift')}>
                                <div className="flex items-center">Shift {getSortIndicator('shift')}</div>
                            </th>
                            <th scope="col" className="sm:px-6 px-2 sm:py-2.5 py-1.5 cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-600" onClick={() => handleSort('status')}>
                        ...
                        {currentTableData.length > 0 ? currentTableData.map((data) => ( 
                            <tr key={data.id} className={`bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700 ${ (isPending && rowLoadingId === data.id) ? 'cursor-wait bg-gray-100 dark:bg-gray-700' : 'hover:bg-gray-50 dark:hover:bg-gray-600 cursor-pointer'}`} onClick={() => handleRowClick(data.id)}>
                                {(isPending && rowLoadingId === data.id) ? (
                                    <td colSpan={10} className="sm:px-6 px-1.5 sm:py-2.5 py-1 text-center"><div className="flex justify-center items-center sm:h-6 h-3.5"><Spinner /></div></td>
                                ) : (
                                    <>
                                        ...
                                        <td className="sm:px-6 px-2 sm:py-2.5 py-1.5 2xl:table-cell hidden"> {data.semester} </td>
                                        <td className="sm:px-6 px-2 sm:py-2.5 py-1.5 sm:table-cell hidden">
                                            <div className="max-w-[65px] truncate" title={data.shift}>
                                                {data.shift}
                                            </div>
                                        </td>
                                        <td className="sm:px-6 px-2 sm:py-2.5 py-1.5 capitalize"><span className={`px-2 py-0.5 rounded-full sm:text-xs text-[7px] font-medium ${data.status.toLowerCase() === 'active' ? 'bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-200' : 'bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-200'}`}>{data.status}</span></td>
                                    </>
                                )}
                            </tr>
                        )) : (
                    ...
                    <tfoot className="sm:text-xs text-[] text-gray-700 border-t border-gray-200 bg-gray-50 dark:text-gray-400 dark:border-gray-600 dark:bg-gray-700">
                        <tr className='sm:text-xs text-[7px]'>
                            <td className="sm:px-6 px-2 sm:py-2.5 py-1.5 md:table-cell hidden"></td>
                            <td className="sm:px-6 px-2 sm:py-2.5 py-1.5">
                                <input type="text" placeholder="Search name..." value={searchTexts.name} onChange={(e) => handleSearchChange('name', e.target.value)} className="block w-full p-1.5 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring-2"/>
                            </td>
                            <td className="sm:px-6 px-2 sm:py-2.5 py-1.5 lg:table-cell hidden">
                                <input type="text" placeholder="Search gen..." value={searchTexts.generation} onChange={(e) => handleSearchChange('generation', e.target.value)} className="block w-full p-1.5 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring-2"/>
                            </td>
                            <td className="sm:px-6 px-2 sm:py-2.5 py-1.5 lg:table-cell hidden">
                                <input type="text" placeholder="Search group..." value={searchTexts.group} onChange={(e) => handleSearchChange('group', e.target.value)} className="block w-full p-1.5 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring-2"/>
                            </td>
                            <td className="sm:px-6 px-2 sm:py-2.5 py-1.5">
                            ...
                            <td className="sm:px-6 px-2 sm:py-2.5 py-1.5">
                                <input type="text" placeholder="Search degrees..." value={searchTexts.degrees} onChange={(e) => handleSearchChange('degrees', e.target.value)} className="block w-full p-1.5 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring-2"/>
                            </td>
                            <td className="sm:px-6 px-2 sm:py-2.5 py-1.5 2xl:table-cell hidden">
                                <input type="text" placeholder="Search faculty..." value={searchTexts.faculty} onChange={(e) => handleSearchChange('faculty', e.target.value)} className="block w-full p-1.5 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring-2"/>
                            </td>
                            <td className="sm:px-6 px-2 sm:py-2.5 py-1.5 2xl:table-cell hidden">
                                <input type="text" placeholder="Search sem..." value={searchTexts.semester} onChange={(e) => handleSearchChange('semester', e.target.value)} className="block w-full p-1.5 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring-2"/>
                            </td>
                            <td className="sm:px-6 px-2 sm:py-2.5 py-1.5 sm:table-cell hidden">
                                <input type="text" placeholder="Search shift..." value={searchTexts.shift} onChange={(e) => handleSearchChange('shift', e.target.value)} className="block w-full p-1.5 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring-2"/>
                            </td>
