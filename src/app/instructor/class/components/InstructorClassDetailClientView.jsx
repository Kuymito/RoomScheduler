...
const ScheduledInstructorCard = ({ instructor }) => (
 ...
 const StudyModeTag = ({ mode }) => {
    ...
    return (
        <div className={`rounded-md bg-white px-3 py-1 text-xs font-semibold ${style}`}>
            {mode}
        </div>
    );
};
              ...
              <ul className="text-sm text-gray-600 dark:text-gray-300 space-y-1">
                <li>
                  ...
                  <span className="font-semibold">
                    {classDetails.generation}
                  </span>
                </li>
                <li>
                  Group :{" "}
                  <span className="font-semibold">{classDetails.group}</span>
                </li>
                <li>
                  Semester :{" "}
                  <span className="font-semibold">{classDetails.semester}</span>
                </li>
                <li>
                  Shift :{" "}
                  <span className="font-semibold">{classDetails.shift}</span>
                </li>
              </ul>
            </div>
