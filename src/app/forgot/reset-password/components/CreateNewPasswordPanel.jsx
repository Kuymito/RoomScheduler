  ...
  return (
    <div className="right-panel bg-gray-100 p-8 md:p-10 lg:py-[50px] lg:px-[60px] w-full lg:w-[45%] flex flex-col justify-center items-center min-h-[350px] lg:min-h-full">
      <div className="form-container w-full max-w-md text-left"> {/* Changed max-w-sm to max-w-md for a bit more space */}
        <h2 className="text-3xl sm:text-[32px]  mb-2 font-bold text-black">
          Create new password
        </h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          {/* Password Field */}
          <div>
            <label htmlFor="password" className="block sm:text-[19px]  mb-1 font-bold text-black">
              Password
            </label>
            <div className="relative">
              <input
                ...
                required
                className={`w-full p-3 pr-10 bg-white rounded-md text-gray-400 box-border 
          ...
          <div>
            <label htmlFor="confirmPassword" className="block   sm:text-[19px]  mb-1 font-bold text-black">
              Confirm Password
            </label>
            <div className="relative">
              <input
