...
const NotificationPopup = ({
  ...
  return (
    ...
    <div
      className="fixed md:absolute w-[400px] h-[600px] bg-white shadow-[0px_2px_15px_rgba(0,0,0,0.25)] rounded-[10px] z-[1000] flex flex-col right-5 top-20 md:right-auto md:left-auto" // Default fixed position, can be overridden by style prop
    ...
    >
      ...
      <div className="relative flex justify-between items-center py-[20px] px-[21px]"> {/* padding simplified. top:20px, left:21px for title */}
        <h2 className="font-roboto font-semibold text-xl leading-[23px] text-black">
          Notifications
        </h2>
        ...
        <div className="flex flex-row justify-end items-center gap-3"> {/* gap: 12px */}
          <button
            ...
            className="font-inter font-medium text-xs leading-tight text-[#2E70E8] hover:underline" // line-height: 100% (12px)
      ...
      <div className="flex flex-col items-start flex-1 overflow-y-auto border-t border-[#E2E8F0]"> {/* top: 74px implies it's below header. Added border */}
