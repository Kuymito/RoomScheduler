...
const RoomViewContent = () => {
    ...
    const handleSaveChanges = async () => {
        ...
        try {
            ...
            setIsEditing(false);
            setShowSuccessAlert(true); // <-- SHOW ALERT ON SUCCESS
    ...
    return (
        <>
            {/* Conditionally render the SuccessAlert as an overlay */}
            {showSuccessAlert && (
            ...
            <div >
                ...
                <div className="flex flex-col lg:flex-row gap-6">
                                    ...
                                    <div className="floor-section">
                                        ...
                                        <div className="grid grid-cols-[repeat(auto-fill,minmax(180px,1fr))] gap-x-4 gap-y-2.5">
                                            {rooms.map((roomId) => (
                                                <div
                                                    key={roomId}
                                                    className={`h-[100px] border ${selectedRoom === roomId && !isEditing
                                                            ? "border-blue-600"
                    ...
                    <div className="w-full lg:w-[304px] shrink-0"> {/* Main container for details section */}
                        <div className="flex items-center gap-1.5 mb-4"> {/* Title "Details" + hr */}
                        ...
                        <div className="flex flex-col items-start gap-[32px] w-[304px] h-[406px]">
                            {loading && !isEditing && !roomDetails ? ( // Show loading only if no room details yet and not in edit mode for another room
                            ...
                            {roomDetails && (
                                <button
                                    ...
                                    disabled={loading && isEditing} // Disable button if it's already saving
                                >
