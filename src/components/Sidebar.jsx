...
const NavItem = ({ href, icon: Icon, label, isActive, isCollapsed, onClick, isNavigating }) => (
  <Link href={href}>
    {/* Removed the <a> tag. Applied its props to the outer div instead. */}
    {/* The Link component will make this div clickable and handle navigation. */}
    <div
      onClick={onClick} // Keep your onClick handler if it performs other actions
