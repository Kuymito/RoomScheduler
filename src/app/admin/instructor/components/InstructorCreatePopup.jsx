                    ...
                    <div className="grid grid-cols-2 gap-4 mb-24">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                onChange={handleInputChange}
                                className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="+855 12 345 678"
                                required
                            />
                        </div>
                        {/* Major Studied and Qualifications in a grid */}
                        <div>
                            <label htmlFor="majorStudied" className="block mb-2 text-sm font-medium text-gray-700 dark:text-gray-300">Major</label>
                            <select
                                id="majorStudied"
                                name="majorStudied"
                        ...
                        <div>
                            <label htmlFor="qualifications" className="block mb-2 text-sm font-medium text-gray-700 dark:text-gray-300">Degree</label>
                            <select
                                id="qualifications"
                                name="qualifications"
