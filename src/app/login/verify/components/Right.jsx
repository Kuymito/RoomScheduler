    ...
    <div className="right-panel bg-gray-100 p-8 md:p-10 lg:py-[50px] lg:px-[60px] w-full
     lg:w-[45%] flex flex-coljustify-center items-center min-h-[350px] lg:min-h-full">
      <div className="form-container w-full max-w-sm text-center relative left-27 ">
        <h2 className="text-3xl sm:text-[32px]  mb-8 font-bold  relative right-23 ">
          Verification
        </h2>
        <p className="instructions text-sm relative right-5 mb-4 leading-normal">
          ...
          <div className="flex justify-center space-x-2 sm:space-x-3 md:space-x-4">
            {otp.map((digit, index) => (
              <input
                ...
                maxLength="1"
                required
                className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 text-center border border-num-border rounded-md text-xl sm:text-2xl font-medium
        ...
        <p className="mt-4 text-sm relative right-15">
