...
const fetchRoomData = async () => {
    const initialRoomsData = {
        ...
        MeetingA: { id: "MeetingA", name: "Meeting Room A", building: "Building A", floor: 1, capacity: 100, equipment: ["Projector", "Whiteboard", "Conference System", "Video Conferencing"], status: "unavailable" }, // 10th room on Floor 1
        ...
        A18: { id: "A18", name: "Room A18", building: "Building A", floor: 2, capacity: 18, equipment: ["Whiteboard"], status: "available" }, // Total 9 rooms on Floor 2
        ...
        A25: { id: "A25", name: "Room A25", building: "Building A", floor: 3, capacity: 20, equipment: ["Projecter", "AC"], status: "available" }, // Total 7 rooms on Floor 3
        ...
        // Building D: 3 floors, 1 library room per floor. Floor 1 library unavailable.
        ...
        E26: { id: "E26", name: "Room E26", building: "Building E", floor: 5, capacity: 9, equipment: ["Whiteboard"], status: "available" }, // Total 5 rooms on Floor 5
