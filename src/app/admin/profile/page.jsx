...
function ProfileContent() {
        ...
        if (section === 'general') {
            ...
            if (selectedFile) {
                ...
                try {
                    ...
                    setToast({ show: true, message: `Image upload failed: ${uploadError.message}`, type: 'error' });
                    setIsLoading(false);
            ...
            try {
                ...
                const profilePayload = {
                    ...
                    phoneNumber: editableProfileState.phoneNumber,
    ...
    return (
        <div className="sm:p-6 p-2">
            ...
            <div className="section-title font-semibold text-lg text-gray-800 dark:text-gray-200 sm:mb-4 mb-2">
                Profile
            </div>
                ...
                <div className="avatar-card w-full lg:w-[220px] h-auto p-3 bg-white border border-gray-300 dark:bg-gray-800 dark:border-gray-700 shadow-sm rounded-lg flex-shrink-0 self-start">
                    <div className="avatar-content flex items-center">
                        ...
                        <div className="avatar-info flex flex-col">
                            <div className="lg:max-w-[120px] max-w-[200px] avatar-name font-semibold text-sm text-gray-800 dark:text-gray-200 mb-0.5 truncate" title={`${displayedProfileData.firstName} ${displayedProfileData.lastName}`}>
