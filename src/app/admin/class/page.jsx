        ...
        <div className="p-6 dark:text-white">
            ...
            <div className="flex items-center justify-between mt-2 mb-4 gap-2">
                ...
                <button
                    ...
                    className="text-white bg-[#75B846] hover:bg-[#87D94D] focus:ring-2 focus:ring-green-600 font-medium rounded-md text-xs px-3 py-2 text-center inline-flex items-center dark:bg-[#75B846] me-2 mb-2 dark:hover:bg-[#79c344] dark:focus:ring-green-800 gap-1"
                >
